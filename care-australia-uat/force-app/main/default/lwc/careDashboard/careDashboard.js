...
export default class CareDashboard extends LightningElement {
    ...
    console.log('first name ', this.DateOfBirth)
    }
    ...
    confirmChanges() {
        ...
        putContactInfo({ contactId: this.contactid, FirstName: this.FirstName, LastName: this.LastName , Title: this.Title, BirthDate: this.DateOfBirth}) //LWC_AllLoansCtrl.putContactInfo('003AD00000Bs9xdYAB','Anirudh','Test');
            .then(updatedContact => {
