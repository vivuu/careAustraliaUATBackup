...
export default class Lwr_careAllLoanSchedules extends LightningElement {
    borrowerspage;
    loanId;
    repaymentSchedules;
    ...
    connectedCallback(){
        ...
        this.loanId = this.getUrlParamValue(location.href, 'loanId');
        ...
        this.borrowerspage = basePath+'careborrowers?loanId='+btoa(this.loanId);
