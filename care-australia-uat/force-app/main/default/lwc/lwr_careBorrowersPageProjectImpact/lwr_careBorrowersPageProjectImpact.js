...
export default class Lwr_careBorrowersPageProjectImpact extends LightningElement {
    coverImage;
    view14 = false;
    ...
    wiredCustomSectionMetaDataRecords({ data, error }) {
        if (data && data.length > 0) {
            console.log('@@@ enter into wire for Project impact');
            console.log('@@@length:', data.length);
            console.log('@@@ data :', data);

            for (let i = 0; i < data.length; i++) {
                if (data[i].MasterLabel == "Project impact") {
                    this.val1 = data[i].Value_1__c;
                    this.val2 = data[i].Value_2__c;
                }
            }
            console.log('@@@ Project  in val1:', this.val1);
            console.log('@@@ impact in val2:', this.val2);
            ...
            if( result!=undefined && result.CMSContent!=undefined ){
                ...
                if (r != undefined) {
                    ...
                    if (arr.length > 0) {
                        ...
                        console.log('@@@ project impact',this.projectImpact);
                    }
                }
            }
            setTimeout(() => {
