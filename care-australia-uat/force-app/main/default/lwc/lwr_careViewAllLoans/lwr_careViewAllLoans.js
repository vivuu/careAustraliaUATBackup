...
export default class Lwr_careViewAllLoans extends LightningElement {
    cartIcon = cartIcon;
    @track cart = [];
    canLoadmore = true;
    ...
    gotoBorrowersPageFL() {
        ...
        location.assign('careborrowers?loanId=' + btoa(this.FLId))
    ...
    gotoBorrowersPage(event) {
        ...
        location.assign('careborrowers?loanId=' + btoa(recordId))
