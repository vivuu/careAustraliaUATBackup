...
import fetchLookupData from '@salesforce/apex/StripeCustomLookupCtrl.fetchLookupData';
import fetchDefaultRecord from '@salesforce/apex/StripeCustomLookupCtrl.fetchDefaultRecord';
const DELAY = 300; // dealy apex callout timing in miliseconds 

export default class StripeCustomLookup extends LightningElement {
   ...
   // initial function to populate default selected lookup record if defaultRecordId provided  
    ...
    @wire(fetchLookupData, { searchKey: '$searchKey' , sObjectApiName : '$sObjectApiName',whereClause:'$filter' })
     searchResult(value) {
...
// send selected lookup record to parent component using custom event
    lookupUpdatehandler(value){    
        ...
        {
            'detail': {selectedRecord: value,uniqueIdentifier:this.uniqueIdentifier}
        }
        );
